...
$sql = "SELECT correspondre.Id_question, question.Libelle_question, reponse.Libelle_reponse, reponse.Correct, seance.Code_quizz
FROM question INNER JOIN correspondre ON question.Id_question = correspondre.Id_question
INNER JOIN reponse ON correspondre.Id_reponse = reponse.Id_reponse
INNER JOIN poser ON question.Id_question = poser.Id_question
INNER JOIN seance ON seance.Id_seance = poser.Id_seance WHERE seance.Code_quizz = 171023
ORDER BY correspondre.Id_question";
